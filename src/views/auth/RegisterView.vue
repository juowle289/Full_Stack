        ...
        <div class="auth-form-wrapper">
          ...
          <template v-if="success">
            ...
            <div class="success-state">
              ...
              <p>Tài khoản độc giả của bạn đã sẵn sàng. Bạn có thể sử dụng tất cả dịch vụ của Thư Viện Số ngay bây giờ.
              </p>

              <v-btn color="primary" size="large" rounded="lg" block append-icon="mdi-arrow-right"
            ...
            <form class="auth-form" @submit.prevent="handleRegister">
              <div class="field-group">
                ...
                <div class="input-wrap">
                  <input v-model="form.fullName" placeholder="Nhập họ và tên của bạn" autocomplete="name"
                    :disabled="loading" />
                </div>
              </div>
              ...
              <div class="field-group">
                <label>Email</label>
                <div class="input-wrap">
                  <input v-model="form.email" type="email" placeholder="ví dụ: tenban@email.com" autocomplete="email"
                    :disabled="loading" />
                </div>
              </div>
              ...
              <div class="field-row">
                <div class="field-group">
                  ...
                  <div class="input-wrap">
                    <input v-model="form.password" :type="showPassword ? 'text' : 'password'" placeholder="Tạo mật khẩu"
                ...
                <div class="field-group">
                  ...
                  <div class="input-wrap">
                    <input v-model="form.confirmPassword" :type="showConfirmPassword ? 'text' : 'password'"
                      placeholder="Nhập lại mật khẩu" autocomplete="new-password" :disabled="loading" />
              ...
              <div class="field-group">
                ...
                <div class="input-wrap input-wrap-textarea">
                  <textarea v-model="form.address" placeholder="Nhập địa chỉ hiện tại của bạn" rows="2"
              ...
              <v-btn type="submit" color="primary" size="large" block rounded="lg" append-icon="mdi-arrow-right"
                :loading="loading">
                Đăng ký
              </v-btn>
